...
class Login(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        newDestination = tk.Button(frame_form_fill, text="Create new Destination", font=('Times', 15, BOLD), bg='#3a5ff6', bd=0, fg="#fff", command=lambda: controller.show_frame("NewDestination"))
        newDestination.pack(fill=tk.X, padx=20, pady=20)